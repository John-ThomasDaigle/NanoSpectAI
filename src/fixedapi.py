...
logo_path = os.path.join(ASSETS_DIR, "saulogo.jpg")
john_path = os.path.join(ASSETS_DIR, "John.jpg")
josh_path = os.path.join(ASSETS_DIR, "Josh.png")
jackson_path = os.path.join(ASSETS_DIR, "jackson_upright.jpg")
...
def generate_inspection_report(
    ...
    # Generate AI content
    for item in pairs:
        item["title"] = generate_image_title(
            item["image_path"],
            item["context"]
        )

        item["description"] = generate_inspection_description(
            item["image_path"],
            item["context"]
        )
